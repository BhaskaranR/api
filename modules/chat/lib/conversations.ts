...
export const newConversation = (message, next) => {
...
export const getConversationsByUserId = (message, next) => {
...
export const getConversationById = (message, next) => {
...
export const ackConversation = (message, next) => {
